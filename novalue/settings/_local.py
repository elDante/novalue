...
ROOT_URLCONF = 'novalue.urls'
WSGI_APPLICATION = 'novalue.wsgi.application'
SECRET_KEY = 'bj^ylwi=igx2dj^^hv*ca*_uh*98p5e9-kx0%9dlu+b%pdv%+o'

# This is where css/images will be placed for your webserver to read
STATIC_ROOT = "/var/www/novalue/static/"
